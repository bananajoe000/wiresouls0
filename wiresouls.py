...
if x == 10 :
 ...
 if number == ("1") :
  ...
  ip_addr = input("Enter The Target IP : ")
  print(Fore.GREEN + "[*] The Target IP is",ip_addr)
  time.sleep(2)
  print(colored("[*] Please Wait",'green'))
  time.sleep(2)
  print(colored("[*] Scanning",'red'))
  time.sleep(2)
  scanner.scan(ip_addr, '1-1024' , '-Pn')
  print(Fore.BLUE + "[*] Ip Status : ", scanner[ip_addr].state())
